...
public class CustomImplicitDatabaseNamingStrategy implements ImplicitDatabaseObjectNamingStrategy {
    ...
    public QualifiedName determineSequenceName(Identifier catalogName, Identifier schemaName, Map<?, ?> configValues,
        ...
        String seqName = ((String) configValues.get("jpa_entity_name")).concat("_custom_seq");
